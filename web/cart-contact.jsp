    ...
    <body>
        ...
        <section id="shopping-cart-section">
            <div class="cart-container">
                <h2 class="cart-title">Check out</h2>
                                ...
                                <td>
                                    <div class="quantity-controls">
                                        <form action="update-cart" method="post" style="display:inline;">
                                            ...
                                            <input type="number" class="item-quantity"  name="quantity" value="${item.quantity}" min="1" max="${item.productDetail.stock}" readonly>
                                        </form>
                                    </div>
                                </td>
                                <td class="item-total">
        ...
        <section id="checkout-section">
            <div class="checkout-container">
                ...
                <form id="checkout-form" action="../public/payment" method="post">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <!-- Special Notes and Payment Method -->
                            <div class="form-group">
                                <label for="customer-note">Special Notes:</label>
                                <input
                                    type="text"
                                    id="customer-note"
                                    name="notes" 
